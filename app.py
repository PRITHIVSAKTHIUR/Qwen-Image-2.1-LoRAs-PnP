...
BEST_FACE_SWAP_REPO = "Alissonerdx/BFS-Best-Face-Swap"
BEST_FACE_SWAP_FILE = "bfs_head_v1_qwen_2.1.safetensors"
BEST_FACE_SWAP_ADAPTER = "best_face_swap"
...
BEST_FACE_SWAP_MODE = "Best Face Swap (Alissonerdx)"
CUSTOM_MODE = "Custom LoRA (enter repo below)"

MODE_CHOICES = [DEFAULT_MODE, TURBO_MODE, OBJECT_MOVER_MODE, OBJECT_REMOVER_MODE, NATURAL_EXPOSURE_MODE, BEST_FACE_SWAP_MODE, CUSTOM_MODE]
...
LORA_PRESETS = {
    ...
    BEST_FACE_SWAP_MODE: (BEST_FACE_SWAP_REPO, BEST_FACE_SWAP_FILE, BEST_FACE_SWAP_ADAPTER),
}
